    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
          ...
          echo '<li><a class="nav-link scrollto" href="http://localhost/reqwest/AddWork.php">control panel </a></li>';
        } else {
          echo '<li><a class="nav-link scrollto" href="http://localhost/#about">About</a></li>';
          echo '<li><a class="nav-link scrollto" href="http://localhost/#services">Services</a></li>';
        } ?>
        <li>
          <?php
          if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
